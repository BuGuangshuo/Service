                  ...
                  Approve.create(
                    {
                      ...
                      approveStatus,
                      approveUser,
                      infoName: data2.infoName,
                      privinceData: data2.privinceData,
                      secondCity: data2.secondCity,
                      status: data2.status,
                      career: data2.career,
                      salary: Number(data2.salary),
                      avaterSrc: data2.avaterSrc,
                      groupId: data3.groupId,
          ...
          GroupModel.findOne(
            ...
            function (err, data3) {
              ...
              GroupModel.updateOne(
                { createUserName: approveUser },
                { memberCount: data3.memberCount + 1 },
                function (err, data2) {
                  if (err) throw err;
                }
              );
